...
export function CanvasNodeContextMenu({ menu, onClose, onDuplicate, onCopyImage, onDelete }: { menu: ContextMenuState; onClose: () => void; onDuplicate: () => void; onCopyImage?: () => void; onDelete: () => void }) {
    ...
    return (
        ...
        >
            ...
            {menu.type === "node" && onCopyImage ? <MenuButton icon={<ImageDown className="size-4" />} label="复制当前图片" onClick={onCopyImage} /> : null}
