...
assert(providerImageQuality('1k') === 'auto', '1K must not be converted to low quality');
assert(providerImageQuality('2k') === 'auto', '2K must not be converted to medium quality');
assert(providerImageQuality('4k') === 'auto', '4K must not be converted to high quality');
