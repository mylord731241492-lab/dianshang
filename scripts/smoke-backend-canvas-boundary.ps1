...
try {
  ...
  Assert-Includes -Label "canvas html" -Text $canvasHtml -Needle "canvas-chat-prompt-flow.js?v=20260630dialogagent5"
  ...
  $assetPaths = @(
    ...
    "/assets/canvas-chat-prompt-flow.js?v=20260630dialogagent5",
    "/assets/canvas-chat-prompt-flow.css?v=20260630dialogagent5",
