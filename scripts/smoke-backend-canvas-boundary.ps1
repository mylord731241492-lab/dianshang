...
try {
  ...
  Assert-Includes -Label "canvas html" -Text $canvasHtml -Needle "canvas-chat-prompt-flow.js?v=20260630dialogagent6"
  Assert-Includes -Label "canvas html" -Text $canvasHtml -Needle "admin-api-source-route-bridge.js?v=20260629sourceapi1"
  Assert-Includes -Label "canvas html" -Text $canvasHtml -Needle "index-DglIsp_g.js?v=20260630dialogagent6"
  ...
  $assetPaths = @(
    ...
    "/assets/canvas-chat-prompt-flow.js?v=20260630dialogagent6",
    "/assets/canvas-chat-prompt-flow.css?v=20260630dialogagent6",
    "/assets/admin-api-source-route-bridge.js?v=20260629sourceapi1",
    "/assets/index-DglIsp_g.js?v=20260630dialogagent6",
