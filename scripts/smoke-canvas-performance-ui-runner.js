async page => {
  ...
  const initialState = await page.evaluate(() => {
    ...
    return {
      ...
      imageNodePolishCssLoaded: styles.some((src) => src.includes('/assets/canvas-image-node-polish.css?v=20260703mask1')),
      imageNodePolishJsLoaded: scripts.some((src) => src.includes('/assets/canvas-image-node-polish.js?v=20260703mask1')),
      appBundlePerfVersion: scripts.some((src) => src.includes('/assets/index-DglIsp_g.js?v=20260703freegen1')),
